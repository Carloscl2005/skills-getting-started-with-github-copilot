...
activities = {
    ...
    "Gym Class": {
        ...
        "max_participants": 30,
        "participants": ["john@mergington.edu", "olivia@mergington.edu", "benjamin@mergington.edu"]
    },
    # Sports activities
    "Soccer Team": {
    ...
    "Basketball Team": {
        "description": "School basketball team practices and games",
    ...
    "Science Fair": {
        "description": "Prepare for regional science fair competitions",
